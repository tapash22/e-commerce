...
<div class="navigation">
                                    ...
                                    <v-form ref="form">
                                        <v-row>
                                            <v-col cols="12" sm="6" md="6">
                                                <v-text-field v-model="form1.name" label="First Name"></v-text-field>
                                            </v-col>
                                            ...
                                            <v-col class="d-flex ml-auto" cols="12" sm="3" xsm="12">
                                                <v-btn x-large block color="success" @click="signup">Register</v-btn>
                                            </v-col>
                                        </v-row>
                                    </v-form>
                                </v-card-text>
    ...
    <v-app-bar color="deep-purple accent-4" dark>
        ...
        <v-app-bar-title>
            <router-link :to="{ name: 'home' }" class="white--text font-weight-bold" style="display:inline-block;text-decoration:none;"> E-Commerce </router-link>
        </v-app-bar-title>
        ...
        <v-menu offset-y bottom left rounded>
            <template v-slot:activator="{ on, attrs }">
                <v-badge :content="cartItemCount" :value="cartItemCount"  color="red" offset-x="15" offset-y="20" right overlap>
        ...
        <div class="mx-3">
            <v-badge :content="wishingItemCount" :value="wishingItemCount" color="red" class="text-body-1" right overlap>
                <v-icon class="text-h5" @click="getLink()">
                    mdi-heart
                </v-icon>
            </v-badge>
        </div>
