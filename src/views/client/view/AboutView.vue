<template>
  <div class="mx-24">
    ...
    <date-pick class="form-control w-64 padding d-block my-2 text-lg" style="font-size:16px;"
      v-model="form.nextrefilldate" :startWeekOnSunday="true" :format="'YYYY.MM.DD'"></date-pick>
    ...
    <v-list>
      ...
      <h2>List of value</h2>
      <v-list-item v-for="featech in  fetching" :key="featech.id">
        <v-list-item-title>{{ featech.email }}</v-list-item-title>
        <v-list-item-subtitle>{{ featech.nextrefilldate }}</v-list-item-subtitle>
      </v-list-item>
    </v-list>
  ...
  data() {
    return {
      ...
      fetching: [
        {
        id:1,
        email: "eeeeeeeeeeeeeeeeeeeeeeeee",
        credits: 0,
        nextrefilldate: "8-12-2022",
      },
      {
        id:2,
        email: "eeeeeeeeeeeee",
        credits: 0,
        nextrefilldate: "5-12-2022",
      },
      ],
    };
  },
